...
!`gh issue view $ARGUMENTS --json number,title,body,labels,assignees,state 2>/dev/null; true`
...
!`gh issue view $ARGUMENTS --json comments -q '.comments[-3:] | .[].body' 2>/dev/null | head -30; true`
